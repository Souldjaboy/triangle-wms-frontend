    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 text-black">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-gray-500">Réglages généraux, produits, reçus, caisse et modes de paiement autorisés.</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        <div className="bg-white rounded-2xl shadow p-5 xl:col-span-1">
          ...
          <div className="grid gap-3">
            ...
            <input type="number" min="0" max="4" value={settings?.decimal_count ?? 0} onChange={(e) => updateSetting("decimal_count", e.target.value)} placeholder="Nombre décimales" className="border p-3 rounded-xl" />
        ...
        <div className="bg-white rounded-2xl shadow p-5 xl:col-span-2">
          <h2 className="text-2xl font-bold mb-4">Paramètres caisse générale</h2>
          <p className="text-gray-500 mb-5">
            Les caisses, ouvertures, fermetures et affectations utilisateurs sont gérées dans le module Caisses.
          </p>
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            <a href="/pos/caisses" className="rounded-xl bg-black px-5 py-3 text-center font-bold text-white">
              Gérer les caisses
            </a>
            <a href="/pos/rapport-caisses" className="rounded-xl bg-white px-5 py-3 text-center font-bold text-black border">
              Rapport caisses
            </a>
            <a href="/pos/parametres-paiement" className="rounded-xl bg-yellow-500 px-5 py-3 text-center font-bold text-black">
              Paramètres paiement
            </a>
          </div>
        </div>
